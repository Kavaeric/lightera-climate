...
export function SimulationProvider({ children }: SimulationProviderProps) {
  const [activeSimulationConfig, setActiveSimulationConfig] =
    useState<SimulationConfig>(SIMULATION_CONFIG_DEFAULT);
  const [activeOrbitalConfig, setActiveOrbitalConfig] =
    useState<OrbitalConfig>(ORBITAL_CONFIG_EARTH);
  const [activePlanetaryConfig, setActivePlanetaryConfig] =
  ...
  const registerOrchestrator = useCallback(
