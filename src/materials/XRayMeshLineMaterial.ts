...
export class XRayMeshLineMaterial extends THREE.ShaderMaterial {
	...
	constructor(parameters?: XRayMeshLineMaterialParameters) {
		...
		Object.defineProperties(this, {
			...
			gradient: {
				enumerable: true,
				get() { return this.uniforms.gradient.value },
				set(value) { this.uniforms.gradient.value = value },
			},
			opacity: {
				enumerable: true,
			...
			useGradient: {
				enumerable: true,
				get() { return this.uniforms.useGradient.value },
				set(value) { this.uniforms.useGradient.value = value },
			},
			visibility: {
				enumerable: true,
			...
			backfacingOpacity: {
				enumerable: true,
				get() { return this.uniforms.backfacingOpacity.value },
				set(value) { this.uniforms.backfacingOpacity.value = value },
			},
			sphereCenter: {
				enumerable: true,
				get() { return this.uniforms.sphereCenter.value },
				set(value) { this.uniforms.sphereCenter.value.copy(value) },
			},
		})
